describe("Move validator", function() {
  it("should report a valid move for moving to a node connected to the current node", function() {
  ...
  it("should report a invalid move for moving to a node not connected to the current node", function() {
      var fake_graph_wrapper = {"get_connected_node_ids": function(id_to_look_for) { return [2,3];}};
      var target_node = new Point(100, 100, 1)
